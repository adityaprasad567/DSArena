...
export default function BinarySearch() {
  ...
  const makeSteps = useCallback(() => binarySearch(array, target), [array, target]);
    ...
    <VisualizerShell
      ...
      toolbar={
        <div className="flex items-center gap-3">
          ...
          <span className="font-tape text-xs text-muted">array is sorted before the search runs</span>
        </div>
      }
    />
  );
